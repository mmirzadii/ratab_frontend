...
export function PricebookBrowserSection({
  ...
  const chaptersPane = (
    <GlassCard className="p-4">
      ...
      <div
        className="mt-4 max-h-[48vh] space-y-2 overflow-y-auto pr-1 [scrollbar-color:rgba(16,185,129,0.55)_rgba(15,23,42,0.25)] [scrollbar-width:thin] md:max-h-[58vh]"
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="truncate text-lg font-black text-white light:text-slate-950">
